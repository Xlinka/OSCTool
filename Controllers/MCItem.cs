...
namespace TeriziaMultitoolS
{
    public static class MCItem
    {
        ...
        static string IDKWhatthefuck;

        public static void GiveItem()
        {

            // Attempt to get the value
            if (MinecraftItemList.TryGetValue(OSCV.TestInt, out string value))
            {
                Console.WriteLine($"Value: {value}");
            }
            else
            {
                Console.WriteLine("Value: Null, Defaulting to air");
            }

            var variablesTuple = (OSCV.WorkBench[1], OSCV.WorkBench[2], OSCV.WorkBench[3], OSCV.WorkBench[4], OSCV.WorkBench[5], OSCV.WorkBench[6], OSCV.WorkBench[7], OSCV.WorkBench[8], OSCV.WorkBench[9]);


            switch (variablesTuple)
            {
                case (17, 0, 0, 0, 0, 0, 0, 0, 0):
                case (0, 17, 0, 0, 0, 0, 0, 0, 0):
                case (0, 0, 17, 0, 0, 0, 0, 0, 0):
                case (0, 0, 0, 17, 0, 0, 0, 0, 0):
                case (0, 0, 0, 0, 17, 0, 0, 0, 0):
                case (0, 0, 0, 0, 0, 17, 0, 0, 0):
                case (0, 0, 0, 0, 0, 0, 17, 0, 0):
                case (0, 0, 0, 0, 0, 0, 0, 17, 0):
                case (0, 0, 0, 0, 0, 0, 0, 0, 17):
                    Console.WriteLine("Allow Crafting wood");
                    break;

                default:
                    Console.WriteLine("Air, Block Crafting Blocked");
                    break;
            }
                       

            Console.WriteLine(OSCV.WorkBench[4]);
        }

        public static Dictionary<int, string> MinecraftItemList = new Dictionary<int, string>
        {
            { 0, "air" }, //air so nothing in slot
            { 1, "stone" },
            { 4, "cobblestone" },
            { 5, "planks" },
            { 6, "sapling" },
